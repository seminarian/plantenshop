...
<script src="jquery/datepicker-nl-BE.js" type="text/javascript"></script>
<script src="jquery/jquery.validate.min.js"></script>
<script src="jquery/directorySlider.js"></script>
<script src="scripts/eindtaak.js" type="text/javascript"></script>
</head>
<body>
<div id="container">
  <div id="kop">
  ...
  <div id="buik">
    ...
    <div id="midden">
      ...
      <div id="inhoud">
        ...
        <div id="vlucht">
          <h1>Vlucht boeken</h1>
          <div class="FoutBox" id="fouten"><ul></ul></div>
